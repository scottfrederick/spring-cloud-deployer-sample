package com.example.deployer.deployer;
...
class AbstractCloudFoundryReactiveDeployer {

	private final RuntimeEnvironmentInfo runtimeEnvironmentInfo;

	final CloudFoundryDeploymentProperties deploymentProperties;

	private final Logger logger = LoggerFactory.getLogger(AbstractCloudFoundryReactiveDeployer.class);

	AbstractCloudFoundryReactiveDeployer(CloudFoundryDeploymentProperties deploymentProperties, RuntimeEnvironmentInfo runtimeEnvironmentInfo) {
